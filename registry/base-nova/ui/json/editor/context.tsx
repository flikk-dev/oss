...
import type { EditorState, EditorStore } from "@/registry/base-nova/ui/json/core/editor";
import type {
  JsonSchema,
  NodePatch,
  SchemaNode,
...
export function useActionTargets(): string[] {
  ...
  if (!field) throw new Error("actions outside a toolbar must be inside <SchemaField.Row>");
  return [field.id];
}
